...
// 	protoc        v3.21.12
// source: api/protobuf/portfolio/portfolio.proto
...
var File_api_protobuf_portfolio_portfolio_proto protoreflect.FileDescriptor

var file_api_protobuf_portfolio_portfolio_proto_rawDesc = []byte{
...
var (
	file_api_protobuf_portfolio_portfolio_proto_rawDescOnce sync.Once
	file_api_protobuf_portfolio_portfolio_proto_rawDescData = file_api_protobuf_portfolio_portfolio_proto_rawDesc
)

func file_api_protobuf_portfolio_portfolio_proto_rawDescGZIP() []byte {
	file_api_protobuf_portfolio_portfolio_proto_rawDescOnce.Do(func() {
		file_api_protobuf_portfolio_portfolio_proto_rawDescData = protoimpl.X.CompressGZIP(file_api_protobuf_portfolio_portfolio_proto_rawDescData)
	})
...
func init() { file_api_protobuf_portfolio_portfolio_proto_init() }
func file_api_protobuf_portfolio_portfolio_proto_init() {
	if File_api_protobuf_portfolio_portfolio_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_api_protobuf_portfolio_portfolio_proto_goTypes,
		DependencyIndexes: file_api_protobuf_portfolio_portfolio_proto_depIdxs,
		MessageInfos:      file_api_protobuf_portfolio_portfolio_proto_msgTypes,
	}.Build()
	File_api_protobuf_portfolio_portfolio_proto = out.File
	file_api_protobuf_portfolio_portfolio_proto_rawDesc = nil
	file_api_protobuf_portfolio_portfolio_proto_goTypes = nil
	file_api_protobuf_portfolio_portfolio_proto_depIdxs = nil
}
